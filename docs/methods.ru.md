...
| `scale_shift` | `content`, `donor_scores`, `similarity` | score calibration | :white_check_mark: | :white_check_mark: | :yellow_circle: medium | нужен scale/shift diagnostic поверх KNN scores |
