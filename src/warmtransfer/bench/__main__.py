"""CLI бенчмарка: ``warmbench --config configs/example.yaml``."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="warmbench", description="Прогон cold-start бенчмарка")
    ...
    print(f"[warmbench] конфиг: {args.config}")
...
def _print_components() -> None:
    from warmtransfer import methods as _methods_pkg  # noqa: F401  # регистрирует методы
