        ...
        for donor_cfg in cfg.donors:
            ...
            for method_cfg in cfg.methods:
                ...
                try:
                    ...
                    print(
                        f"[coldbench] пропуск {method_cfg.key} на доноре "
                        f"{donor_cfg.key}: {exc}"
                    )
                    continue
                t0 = perf_counter()
